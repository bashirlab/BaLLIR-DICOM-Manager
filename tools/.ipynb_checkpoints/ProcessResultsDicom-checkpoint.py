...
class ProcessResultsDicom(ReadPair):
    ...
    def __init__(self, scan, mask_gt, mask_alg, colors = ['#06b70c', '#2c2cc9', '#eaf915'], transparency = 0.3, outline = False, legend_size = False, _middle_slice = False, preprocess_arr = False, align_slices = False):
