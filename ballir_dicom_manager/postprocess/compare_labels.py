...
from ballir_dicom_manager.file_readers.read_multi_image_label_pair import (
    ReadMultiImageLabelPair,
)
from ballir_dicom_manager.directory_manager import DirManager
from ballir_dicom_manager.postprocess.postprocess import PostProcess
from ballir_dicom_manager.file_readers.read_multi_image_label_pair import (
    ReadMultiImageLabelPair,
)
from ballir_dicom_manager.file_readers.read_image_label_pair import (
    ReadImageLabelPair,
)
    ...
    def preview_combined_dicoms(self, **kwargs):
        for case in tqdm(
            ...
            try:
                ...
                multi_pair = ReadMultiImageLabelPair(pair_1, pair_2, allow=self.allow)
