...
class QCSaver(ArrayPlotter):
    ...
    def save(self, QC_PATH: pathlib.Path, qc_file: ReadDicom,  orthoview: bool, **kwargs):
        if orthoview:
    ...
    def save_orthoview(self, QC_PATH, qc_file, **kwargs) -> None:
        ...
        write_path = os.path.join(os.path.dirname(QC_PATH), f'{os.path.basename(QC_PATH)}.png')
